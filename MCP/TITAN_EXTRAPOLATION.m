%% TITAN for solving matrix completion problem (MCP) using Nesterov type extrapolation
...
function [output ] = TITAN_EXTRAPOLATION(D, lam, theta, para )
% D: sparse observed matrix

output.method = 'TITAN_EXTRAPOLATION';
...
for i = 1:maxIter
    ...
    for iner_iter = 1:para.iner
        ...
        part0 = sparse_inp(y_U', V1, row, col);
    ...
    for iner_iter = 1:para.iner
        ...
        part0 = sparse_inp(U1', y_V, row, col);
